...
const WorkshopDetails = ({ workshop }) => {
  ...
  const containerStyle = {
    position: "relative",
    height: "50vh", // Increased height for a more striking visual impact
    marginTop: "40px",
    overflow: "hidden",
  ...
  const imageStyle = {
    ...
    height: "100%",
    background:
      "linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,0.8)), url(https://img.freepik.com/free-photo/diversity-teenager-team-seminar-training-education-concept_53876-146866.jpg?t=st=1711273986~exp=1711277586~hmac=be1a0bacb40ba03d3154a7cd95e1ae3313bb2250485ef749f695fefa29bff254&w=1060)",
    backgroundSize: "cover",
    backgroundPosition: "center",
    filter: "brightness(0.8)", // Slightly adjusted for better text visibility
    borderRadius: "10px", // Match container's rounded corners
  };
